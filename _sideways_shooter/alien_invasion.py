...
class AlienInvasion:
	...
	def _create_fleet(self):
		...
		availaile_space_x = (self.settings.screen_height - 3 * alien_width) - ship_height
		number_aliens_x = availaile_space_x // (1 * alien_height)

		# Determine the number of rows of aliens that fit on the screen.
		availaile_space_y = self.settings.screen_height - (2 * alien_width)
		number_rows = availaile_space_y // (2 * alien_width)
